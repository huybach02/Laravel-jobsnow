...
@section('content')
    <div class="block-header border border-bottom">
        ...
        <ul class="breadcrumb ml-4">
            ...
            <li class="breadcrumb-item active">Danh mục tuyển dụng nổi bật</li>
        </ul>
    </div>
    <div>
        <div class="card">
            <div class="header d-flex align-items-center justify-content-between">
                <h2 class="text-primary">Danh sách danh mục tuyển dụng nổi bật </h2>
                    ...
                    <table id="example" class="display" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Slug</th>
                                <th>Hiển thị ở mục Danh mục nổi bật</th>
                                <th>Hiển thị ở mục Tin tuyển dụng nổi bật</th>
                                <th>Hành động</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($jobCategories as $key => $jobCategory)
                                <tr>
                                            ...
                                            <div class="switch">
                                                <label>
                                                    <input class="change-status" type="checkbox" checked
                                                        ...
                                                        data-url="{{ route('admin.featured-categories-section.change-status') }}">
                                    ...
                                    <td>
                                        @if ($jobCategory->is_job_featured == 1)
                                            <div class="switch">
                                                <label>
                                                    <input class="change-status" type="checkbox" checked
                                                        data-id="{{ $jobCategory->id }}"
                                                        data-url="{{ route('admin.featured-categories-section.change-status-job-featured') }}">
                                                    <span class="lever switch-col-teal"></span></label>
                                            </div>
                                        @else
                                            <div class="switch">
