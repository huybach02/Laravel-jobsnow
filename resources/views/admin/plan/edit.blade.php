...
@section('content')
    <div class="block-header border border-bottom">
        ...
        <ul class="breadcrumb ml-4">
            ...
            <li class="breadcrumb-item active">
                Chỉnh sửa gói dịch vụ << <span class="text-primary">
                    {{ $plan->label }}</span> >></li>
        </ul>
    ...
    <div>
        <div class="card">
            <div class="header">
                <h2 class="text-primary"> Chỉnh sửa gói dịch vụ <span class="text-danger">({{ $plan->label }})</span></h2>
            </div>
            <div class="body">
                                ...
                                <div class="input-group d-flex flex-column">
                                    <div class="form-line {{ $errors->has('job_count') ? 'error focused' : '' }}">
                                        <input type="number" class="form-control" placeholder="VD: 1,2,3,..."
                                            name="job_count" value="{{ old('job_count', $plan->job_count) }}">
                                    </div>
                            ...
                            <div class="col-12 p-0">
                                ...
                                <div class="input-group d-flex flex-column">
                                    <div class="form-line {{ $errors->has('featured_job_count') ? 'error focused' : '' }}">
                                        <input type="number" class="form-control" placeholder="VD: 1,2,3,..."
                                            name="featured_job_count"
                                            value="{{ old('featured_job_count', $plan->featured_job_count) }}">
                                    </div>
                            ...
                            <div class="col-12 p-0">
                                ...
                                <div class="d-flex flex-column">
                                    <select class="form-control border mt-2" name="company_featured_show" id="">
                                        ...
                                        <option {{ $plan->company_featured_show == 1 ? 'selected' : '' }} value="1">
                                            Hiển thị</option>
                                        <option {{ $plan->company_featured_show == 0 ? 'selected' : '' }} value="0">
                            ...
                            <div class="col-12 p-0">
                                ...
                                <div class="d-flex flex-column">
                                    <select class="form-control border mt-2" name="company_verified_show" id="">
                                        <option value="">-- Chọn --</option>
                                        <option {{ $plan->company_verified_show == 1 ? 'selected' : '' }} value="1">
                                            Hiển thị</option>
                                        <option {{ $plan->company_verified_show == 0 ? 'selected' : '' }} value="0">
                                            Không hiển thị</option>
                                    </select>
                            ...
                            <div class="col-12 p-0">
                                ...
                                <div class="d-flex flex-column">
                                    <select class="form-control border mt-2" name="recommended" id="">
                                        <option value="">-- Chọn --</option>
                                        <option {{ $plan->recommended == 1 ? 'selected' : '' }} value="1">Có</option>
                                        <option {{ $plan->recommended == 0 ? 'selected' : '' }} value="0">Không
                                        </option>
                                    </select>
                            ...
                            <div class="col-12 p-0">
                                ...
                                <div class="d-flex flex-column">
                                    <select class="form-control border mt-2" name="status" id="">
                                        <option {{ $plan->status == 1 ? 'selected' : '' }} value="1">Kích hoạt
                                        </option>
                                        <option {{ $plan->status == 0 ? 'selected' : '' }} value="0">Không kích hoạt
                                        </option>
                                    </select>
