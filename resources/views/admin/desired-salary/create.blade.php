...
@section('content')
    ...
    <div>
        <div class="card">
            <div class="header">
                <h2> Thêm mức lương mong muốn </h2>
            </div>
            <div class="body">
                <form action="{{ route('admin.desired-salaries.store') }}" method="POST">
                    @csrf

                    <div class="col-12 p-0">
                        <b>Tên mức lương mong muốn</b>
                        <div class="input-group d-flex flex-column">
                            <div class="form-line {{ $errors->has('name') ? 'error focused' : '' }}">
                                <input type="text" class="form-control" placeholder="VD: Thoả thuận, 3-5 triệu,..."
