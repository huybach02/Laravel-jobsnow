                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="row clearfix top-report">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                <div class="body">
                                    <div class="sparkline" data-type="bar" data-width="97%" data-height="77px"
                                        data-bar-Width="5" data-bar-Spacing="4" data-bar-Color="rgb(69, 127, 202)">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                <div class="body">
                                    <div class="sparkline" data-type="bar" data-width="97%" data-height="77px"
                                        data-bar-Width="5" data-bar-Spacing="4" data-bar-Color="rgb(120, 184, 62)">
                                ...
                                <div class="body">
                                    <div class="row clearfix">
                                        <div class="col-md-7 col-sm-6  text-center">
                                            <input type="text" class="knob" value="93" data-width="110"
                                                data-height="110" data-thickness="0.1" data-fgColor="#f0ad4e" readonly>
                                        </div>
