...
@section('content')
    <div class="block-header border border-bottom">
        ...
        <ul class="breadcrumb ml-4">
            ...
            <li class="breadcrumb-item active">Lĩnh vực hoạt động</li>
        </ul>
    </div>
    <div>
        <div class="card">
            <div class="header d-flex align-items-center justify-content-between">
                <h2 class="text-primary">Danh sách lĩnh vực hoạt động </h2>
                <a href="{{ route('admin.industry-types.create') }}">
                        ...
                        <tbody>
                            @foreach ($industryTypes as $key => $industryType)
                                <tr>
                                            ...
                                            <div class="switch">
                                                <label>
                                                    <input class="change-status" type="checkbox" checked
                                                        ...
                                                        data-url="{{ route('admin.industry-types.change-status') }}">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.industry-types.edit', $industryType->id) }}">
                                            <button type="button" class="btn btn-raised bg-blue waves-effect btn-xs"><i
                                                    class="zmdi zmdi-edit"></i></button>
                                        </a>

                                        <a href="{{ route('admin.industry-types.destroy', $industryType->id) }}"
