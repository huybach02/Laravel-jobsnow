...
@section('content')
    <div class="block-header border border-bottom">
        ...
        <ul class="breadcrumb ml-4">
            ...
            <li class="breadcrumb-item active">Ngoại ngữ thành thạo</li>
        </ul>
    </div>
    <div>
        <div class="card">
            <div class="header d-flex align-items-center justify-content-between">
                <h2 class="text-primary">Danh sách ngoại ngữ thành thạo </h2>
                    ...
                    <table id="example" class="display" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>ID</th>
                                <th>Tên ngoại ngữ thành thạo</th>
                                <th>Slug</th>
                                <th>Trạng thái</th>
                                <th>Hành động</th>
                            </tr>
                                            ...
                                            <div class="switch">
                                                <label>
                                                    <input class="change-status" type="checkbox" checked
                                                        data-id="{{ $language->id }}"
                                                        data-url="{{ route('admin.languages.change-status') }}">
