...
@section('content')
    <div class="block-header border border-bottom">
        ...
        <ul class="breadcrumb ml-4">
            ...
            <li class="breadcrumb-item active">Quy mô tổ chức</li>
        </ul>
    </div>
    <div>
        <div class="card">
            <div class="header d-flex align-items-center justify-content-between">
                <h2 class="text-primary">Danh sách quy mô tổ chức </h2>
                <a href="{{ route('admin.team-sizes.create') }}">
            ...
            <div class="body">
                <div class="table-responsive">
                    <table id="example" class="display" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($teamSizes as $key => $teamSize)
                                <tr>
                                    ...
                                    <td>{{ $teamSize->slug }}</td>
                                    <td>
                                        @if ($teamSize->status == 1)
                                            <div class="switch">
                                                <label>
                                                    <input class="change-status" type="checkbox" checked
                                                        data-id="{{ $teamSize->id }}"
                                                        data-url="{{ route('admin.team-sizes.change-status') }}">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.team-sizes.edit', $teamSize->id) }}">
                                            <button type="button" class="btn btn-raised bg-blue waves-effect btn-xs"><i
                                                    class="zmdi zmdi-edit"></i></button>
                                        </a>

                                        <a href="{{ route('admin.team-sizes.destroy', $teamSize->id) }}"
