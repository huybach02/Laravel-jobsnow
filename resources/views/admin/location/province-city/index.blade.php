    ...
    <div>
        <div class="card">
            <div class="header d-flex align-items-center justify-content-between">
                <h2 class="text-primary">Danh sách tỉnh/thành phố </h2>
                        ...
                        <tbody>
                            @foreach ($provinces as $key => $province)
                                <tr>
                                            ...
                                            <div class="switch">
                                                <label>
                                                    <input class="change-status" type="checkbox" checked
                                                        ...
                                                        data-url="{{ route('admin.province-cities.change-status') }}">
                                    ...
                                    {{-- <td>
                                        <a href="{{ route('admin.province-cities.edit', $province->code) }}">
                                            <button type="button" class="btn btn-raised bg-blue waves-effect btn-xs"><i
                                                    class="zmdi zmdi-edit"></i></button>
                                        </a>

                                        <a href="{{ route('admin.province-cities.destroy', $province->code) }}"
