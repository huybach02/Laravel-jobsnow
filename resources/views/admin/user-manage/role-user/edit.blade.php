...
@section('content')
    <div class="block-header border border-bottom">
        ...
        <ul class="breadcrumb ml-4">
            ...
            <li class="breadcrumb-item active">Chỉnh sửa người dùng << <span class="text-primary">
                    {{ $admin->name }} </span>>>
            </li>
        </ul>
    ...
    <div>
        <div class="card">
            <div class="header">
                <h2 class="text-primary"> Chỉnh sửa người dùng <span class="text-danger">({{ $admin->name }})</span>
                </h2>
            </div>
            <div class="body">
