                ...
                <div class="col-lg-5 col-md-6 col-sm-12 mx-auto mb-120">
                    <div class="login-register-cover">
                        <div class="text-center">
                            ...
                            <p class="font-sm text-muted mb-30">Đặt lại mật khẩu mới cho tài khoản của bạn.</p>
                        </div>
                        <form class="login-register text-start mt-20" method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="input-4">Xác nhận mật khẩu *</label>
                                <input class="form-control" id="input-4" type="password" name="password_confirmation"
                                    placeholder="********">
