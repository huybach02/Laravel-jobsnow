            ...
            <div class="row mb-120">
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-120">
                    <div class="content-single">
                        <h3 class="mt-0 mb-0 color-brand-1">Tạo mới tin tuyển dụng</h3>

                        <a href="{{ route('company.jobs.index') }}" class="btn btn-secondary mt-20">
                            <i class="fas fa-caret-left"></i> Quay lại</a>

                        <div class="mt-40">
                            <form id="jobForm" action="{{ route('company.jobs.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-multiple-1" id="multiple" multiple
                                            ...
                                            @foreach ($jobCategories as $jobCategory)
                                                <option
                                                    {{ in_array($jobCategory?->id, old('job_category') ?? []) ? 'selected' : '' }}
                                    ...
                                    <div class="form-group select-style">
                                        ...
                                        <select class="form-select select-active" name="employment_level">
                                            ...
                                            @foreach ($employmentLevels as $employmentLevel)
                                                <option
                                                    {{ old('employment_level') == $employmentLevel->slug ? 'selected' : '' }}
                                    ...
                                    <div class="form-group select-style">
                                        ...
                                        <select class="form-select select-active" name="salary_structure">
                                            ...
                                            @foreach ($salaryStructures as $salaryStructure)
                                                <option
                                                    {{ old('salary_structure') == $salaryStructure->name ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted font-bold mb-10">Mức lương tối thiểu
                                                (VNĐ)
                                                *</label>
                                            <input class="form-control" type="number" value="{{ old('salary_min') }}"
                                                name="salary_min">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted font-bold mb-10">Mức lương tối đa (VNĐ)
                                                *</label>
                                            <input class="form-control" type="number" value="{{ old('salary_max') }}"
                                                name="salary_max">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="font-sm color-text-mutted font-bold mb-10">Thời gian hết hạn tuyển
                                            dụng
                                            *</label>
                                        <input class="form-control" type="date" value="{{ old('deadline') }}"
                                            name="deadline">
                                    ...
                                    <div class="form-group select-style">
                                        ...
                                        <select class="form-select select-active" name="experience">
                                            ...
                                            @foreach ($experiences as $experience)
                                                <option {{ old('experience') == $experience->slug ? 'selected' : '' }}
                                    ...
                                    <div class="form-group select-style">
                                        ...
                                        <select class="form-select select-active" name="academic_level">
                                            ...
                                            @foreach ($academicLevels as $academicLevel)
                                                <option
                                                    {{ old('academic_level') == $academicLevel->slug ? 'selected' : '' }}
                                ...
                                <div class="col-12">
                                    <div class="form-group select-style">
                                        ...
                                        <select class="form-select select-active" name="gender">
                                            ...
                                            <option {{ old('gender') == 'Nam' ? 'selected' : '' }} value="Nam">Nam
                                            </option>
                                            <option {{ old('gender') == 'Nữ' ? 'selected' : '' }} value="Nữ">Nữ
                                            </option>
                                            <option {{ old('gender') == 'Nam và nữ' ? 'selected' : '' }}
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="font-sm color-text-mutted font-bold mb-10">Số lượng cần tuyển
                                            *</label>
                                        <input class="form-control" type="number" value="{{ old('quantity') }}"
                                            name="quantity">
                                    ...
                                    <div class="form-group select-style">
                                        ...
                                        <select class="form-select select-active" name="work_mode">
                                            ...
                                            @foreach ($workModes as $workMode)
                                                <option {{ old('work_mode') == $workMode->slug ? 'selected' : '' }}
                                                    value="{{ $workMode->slug }}">
                                                    {{ $workMode->name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="col-12">
                                    <div class="form-group w-100 d-flex flex-column">
                                        ...
                                        <input id="tags-input" class="form-control col-12 py-3" name="requirement"
                                            type="text" value="{{ old('requirement') ?? '' }}" data-role="tagsinput"
                                ...
                                <div class="col-12">
                                    <div class="form-group w-100 d-flex flex-column">
                                        ...
                                        <input class="form-control col-12 py-3" name="advanced_skills" type="text"
                                            value="{{ old('advanced_skills') ?? '' }}" data-role="tagsinput"
                                            placeholder="Nhập thêm yêu cầu...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-multiple-2" id="multiple" multiple
                                            ...
                                            @foreach ($softSkills as $softSkill)
                                                <option
                                                    {{ in_array($softSkill?->name, old('soft_skills') ?? []) ? 'selected' : '' }}
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-multiple-3" id="multiple" multiple
                                            ...
                                            <option
                                                {{ in_array('Không yêu cầu ngoại ngữ', old('foreign_languages') ?? []) ? 'selected' : '' }}
                                ...
                                <div class="col-12">
                                    <div class="form-group w-100 d-flex flex-column">
                                        ...
                                        <input class="form-control col-12 py-3" name="benefits" type="text"
                                            value="{{ old('benefits') ?? 'Chế độ bảo hiểm,Nghỉ phép năm,Đồng phục,Tăng lương,Chế độ thưởng' }}"
                                ...
                                <div class="col-12">
                                    <div class="form-group w-100 d-flex flex-column">
                                        ...
                                        <input class="form-control col-12 py-3" name="request_to_apply" type="text"
                                            value="{{ old('request_to_apply') ?? '' }}" data-role="tagsinput"
                                            placeholder="Nhập thêm yêu cầu...">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="font-sm color-text-mutted font-bold mb-10">Người liên hệ
                                            *</label>
                                        <input class="form-control" type="text" value="{{ old('contact_person') }}"
                                            name="contact_person">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="font-sm color-text-mutted font-bold mb-10">Email liên hệ
                                            *</label>
                                        <input class="form-control" type="text" value="{{ old('contact_email') }}"
                                            name="contact_email">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="font-sm color-text-mutted font-bold mb-10">Số điện thoại liên hệ
                                            *</label>
                                        <input class="form-control" type="text" value="{{ old('contact_phone') }}"
                                            name="contact_phone">
